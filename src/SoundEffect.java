...
public enum SoundEffect {
	Background("src//Sound/backgroundTech.wav"), // background music
	Jump("src//Sound/jumpSound.wav"), // Jump sound
	Death("src//Sound/deathSound.wav"); //death noise
	
	  private Clip audioClip;
	  public void startMusic() {
	        
	        File f = new File("Sound/backgroundTech.wav");
	        try {
	...
	public static void setPermVolume() {
		...
		try {
			audioInputStream = AudioSystem.getAudioInputStream(new File("src//Sound/backgroundTech.wav"));
